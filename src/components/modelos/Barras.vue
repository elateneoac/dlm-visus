<template>
    ...
    <div class="container my-3">
        ...
        <div class="row mb-3 justify-content-start">
            ...
            <div v-if="!this.hay_grupos" class="col-2">
                <div class="input-group input-group-sm mb-3">
        ...
        <div class="my-3"></div>
        <EtiquetasControl v-model="etiquetas_parametros"/>
    </div>
</template>
            ...
            dibujar() {
                ...
                if (this.hay_grupos) {
                    ...
                    for(let grupo of this.grupos) {
                        ...
                        var df_grupo = this.df.filter(d => d[this.grupo] == grupo && this.etiquetas_parametros.estetica[d[this.y]].mostrar).sort((a, b) => a[this.x] > b[this.x] ? 1 : -1)
